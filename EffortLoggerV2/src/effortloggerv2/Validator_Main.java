...
class Validator_Main {

	// goal of this class: Data is sent here for validation before reaching server. If data fails validation, return false. Otherwise, return true.
	
	public static boolean validate(String data, String fieldType) throws Exception { 
		...
		switch (fieldType) {
			...
			case "Password":
				...
				break;
			default:
				throw new Exception("Validation Error: invalid fieldtype \"" + fieldType + "\"");		// if type does not match the above
	...
	/*public static boolean validate(double data, String fieldType) { 
		
		/*switch (fieldType) {
			
			// if the field should contain non-negative doubles
