...
public class SharePage {
	...
	public void sharePage(List<PlanningPoker> planningPoker) {
		...
		List<PlanningPoker> planningPokers = UtilityHelper.getTasksFromFile("src\\task.txt");
		System.out.println(planningPokers.size());
		
		ObservableList<PlanningPoker> task = FXCollections.observableList(planningPokers);
