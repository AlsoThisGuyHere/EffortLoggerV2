...
public class TaskPage {
    ...
    private HistoricalData projectDataPage; //creating a historical data variable
    ...
    public void createPlanningPokerPage(Stage primaryStage,
        ...
        projectDataPage = new HistoricalData(); //creating a new instance of project data page
    ...
    public void createPlanningPokerPage(Stage primaryStage,
        ...
        if (authenticationCheck && (user == null || !user.getIsLoggedIn())) {
            ...
            Button historicalData = new Button("Historical Data"); // added by Connor on 11/11/23
            ...
            // call for the method created in HistoricalData.java
            historicalData.setOnAction(new EventHandler<ActionEvent>() {
            	@Override
            	 public void handle(ActionEvent actionEvent) {
            		projectDataPage.ProjectDataPage(primaryStage, users, tasks, true, user);
            	}
            });
            ...
            gridPane.addRow(5, historicalData); // added by Connor on 11/11/23
            gridPane.addRow(6, logoutButton);
